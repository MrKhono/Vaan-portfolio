...
const timeline = [
  {
    ...
    title: "Premiers pas",
    description:
      "Début de ma carrière en tant que photographe assistant dans un studio parisien renommé.",
  },
  {
    year: "2016",
    title: "Studio indépendant",
    description:
      "Ouverture de mon propre studio à Paris et lancement de mon activité de photographe professionnel.",
  },
  {
    year: "2018",
    title: "Reconnaissance",
    description:
      "Prix du meilleur photographe de mariage aux Wedding Awards. Début des collaborations avec des maisons de mode.",
  },
  {
    year: "2020",
    title: "Expansion internationale",
    description:
      "Premiers projets à l'international : Londres, Milan, New York. Collaboration avec Vogue et Harper's Bazaar.",
  },
  {
    year: "2023",
    title: "Masterclass",
    description:
      "Lancement de formations et masterclass pour partager mon expérience avec la nouvelle génération de photographes.",
  },
  {
    year: "2025",
    title: "Aujourd'hui",
    description:
      "Plus de 500 projets réalisés, un réseau de clients fidèles et une passion toujours intacte pour la photographie.",
  },
]

// Icônes de fallback si les valeurs viennent de la BDD
const fallbackValues = [
  { icon: Eye,    title: "Vision",       description: "Chaque projet commence par une vision claire. Je cherche à voir au-delà de l'évident pour capturer l'essence véritable d'un moment." },
  { icon: Heart,  title: "Émotion",      description: "La photographie est avant tout une question d'émotion. Je m'efforce de créer des images qui touchent le cœur et racontent une histoire." },
  { icon: Camera, title: "Excellence",   description: "La maîtrise technique est au service de la créativité. Je perfectionne constamment mon art pour offrir un travail d'exception." },
  { icon: Award,  title: "Authenticité", description: "Pas de poses forcées, pas d'artifices. Je privilégie le naturel et la spontanéité pour des images vraies et intemporelles." },
]

// Résout le nom d'une icône Lucide depuis une string (ex: "Camera" → Camera)
...
export default async function AboutPage() {
  ...
  const description = about.description || "Photographe passionné, conteur d'histoires visuelles, éternel curieux."

  // Utilise les valeurs de la BDD si elles existent, sinon les fallback
  const values = about.values.length > 0
                ...
                <StaggerItem key={item.year}>
                  ...
                  >
                    ...
                    <div className={`flex-1 ${i % 2 === 0 ? "md:text-right md:pr-12" : "md:pl-12"}`}>
                      ...
                      <h3 className="mt-1 font-serif text-xl font-semibold text-foreground">{item.title}</h3>
        ...
        <div className="mx-auto max-w-7xl">
          <FadeIn className="text-center">
            ...
            <div className="mx-auto mt-12 grid max-w-4xl grid-cols-2 gap-8 md:grid-cols-4">
              {["Vogue", "Harper's Bazaar", "Maison Élysée", "Fondation des Arts"].map((client) => (
                <div
                  key={client}
