...
export const metadata: Metadata = {
  title: "Services",
  description:
    "Decouvrez les prestations photographiques d'Alexandre Dupont : mariage, portrait, mode et evenementiel. Tarifs et formules adaptees a vos besoins.",
}
      ...
      <section className="bg-primary px-6 pb-16 pt-32 text-center lg:px-8 lg:pb-24 lg:pt-40">
        <FadeIn>
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-primary-foreground/60">
            {"Des formules adaptees a chaque besoin, avec un engagement constant pour la qualite et l'excellence."}
          </p>
        </FadeIn>
      </section>
        ...
        <div className="mx-auto max-w-3xl text-center">
          <FadeIn>
            ...
            <p className="mx-auto mt-4 max-w-xl text-lg leading-relaxed text-muted-foreground">
              {"Chaque projet est unique. Contactez-moi pour discuter de vos besoins specifiques et recevoir un devis personnalise."}
            </p>
            <Link
              href="/contact"
